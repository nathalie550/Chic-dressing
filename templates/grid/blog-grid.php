...
<div class="main-container">
	...
	echo '<h2 id="leblog" class="chic-title">Dernières publications / Marques de luxe</h2>';
	...
	echo '</ul>';
	echo '<p class="text-center"><<a class="chic-bouton" href="http://localhost:8888/ChicDressing/shop/" aria-current="page">Voir tous les articles</a></p>';
