    ...
    ?>
                <article id="post-<?php the_ID(); ?>" <?php post_class($post_class); ?>>
                    ...
                    <div class="post-media">
                        <a href="<?php echo esc_url(get_permalink()); ?>"> <?php echo get_the_post_thumbnail('medium'); ?></a>
                    ...
                    <div class="post-content-wrap">
                        <header class="post-header">
                            ...
                            <?php if (get_the_title()) : ?>
                                <h2 class="post-title">
                                    <a href="<?php echo esc_url(the_permalink()); ?>"><?php echo the_title('lien page blog'); ?></a>
                                </h2>
                        ...
                        <div class="read-more">
                            <a href="<?php echo esc_url(get_permalink()); ?>"><?php echo esc_html_e('read more', 'ashe'); ?></a>
                        </div>
