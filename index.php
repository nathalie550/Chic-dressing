...
if (is_home()) {
	...
	https: //https://www.google.com/maps/d/embed?mid=1SU-W19k76UkTXASeT7PnGAyDYCY&hl=en_US&ehbc=2E312F&ll=48.86613677100238%2C2.3250974999999974&z=13
...
?>
	<div id="chic-products" class="boxed-wrapper clear-fix">
		...
		?>
		<p class="text-center"><a class="chic-bouton" href="http://localhost:8888/ChicDressing/shop/" aria-label="shop: voirla page shop articles">Voir tous les articles</a></p>
	</div>
	...
	<div id="chic-fashionweek-map" class="boxed-wrapper clear-fix" style="margin-top:30px">
		<h2 class="chic-title">La FashionMap - été 2022 - Achat - Vente </h2>
		<iframe src="https://www.google.com/maps/d/embed?mid=1SU-W19k76UkTXASeT7PnGAyDYCY&hl=en_US&ehbc=2E312F&ll=48.86613677100238%2C2.3250974999999974&z=13" title="Fashion Week Paris" width="100%" height="480"></iframe>';
	</div>
<?php
}
